...
class Field_Forest : Activity() {
    ...
    fun clickable_false(){
        findViewById<Button>(R.id.status_button).isClickable = false
        findViewById<Button>(R.id.back_button).isClickable = false
        findViewById<Button>(R.id.forward_button).isClickable = false
    }

    fun clickable_true(){
        findViewById<Button>(R.id.status_button).isClickable = true
        findViewById<Button>(R.id.back_button).isClickable = true
        findViewById<Button>(R.id.forward_button).isClickable = true
    }
}
